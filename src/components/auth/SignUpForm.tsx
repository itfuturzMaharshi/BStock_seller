                  ...
                  <div className="relative flex">
                    ...
                    <div className="relative w-24 mr-2">
                      <button
                        ...
                        className="flex items-center justify-between cursor-pointer w-full px-3 py-[0.625rem] bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-gray-700 text-sm hover:bg-gray-100 transition-colors h-11" // Adjusted padding and added h-10
                      >
